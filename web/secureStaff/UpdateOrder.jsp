...
<html>
    <head>
        ...
        <!-- ========== Page Title ========== -->
        <title>AG Market Order Status</title>
    ...
    <body>
        ...
        <%
            List<Order> orderList = (List) application.getAttribute("orderList");
            //if (session.getAttribute("sortedOrderList") != null) {
            //orderList = (List<Order>) session.getAttribute("sortedOrderList");
            //}
            int oIndex = 0;
            String statuslight = "";
                            ...
                            <div class="table-responsive p-0">
                                <table class="table table-hover align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th>
                                                <a href="../StaffSortingOrder?sortingCriteria=orderID">Order ID<i class="las la-sort"></i></a>
                                            </th>
                                            <th>
                                                Order Date
                                            </th>
                                            <th>
                                                <a href="../StaffSortingOrder?sortingCriteria=custName">Customer Name<i class="las la-sort"></i></a>
                                            </th>
                                            <th>
                                                <a href="../StaffSortingOrder?sortingCriteria=Total">Total Amount<i class="las la-sort"></i></a>
                                            </th>
                                            <th>
                                                <a href="../StaffSortingOrder?sortingCriteria=orderStatus">Order Status<i class="las la-sort"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
