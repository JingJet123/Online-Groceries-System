...
public class DeleteCartItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            CartItem ci = cartItemService.findCartItemByCompsId(cartId, prodId);
            if (ci != null) {      
                utx.begin();
            ...
            if (success) {
                ...
                session.setAttribute("alertMsg", ci.getProduct().getProdName() + " Successfully Removed from your cart.");
                session.setAttribute("alertType", "success");

                //Set Session Attribute
                session.setAttribute("success", success);
                session.setAttribute("customer", ci.getCart().getCustId());
